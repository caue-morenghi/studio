        ...
        <Box width="100%" sx={{ padding: { xs: "1em", md: "5em" }, display: "flex", flexDirection: { xs: "column", md: "row" }, gap: { xs: "2em", md: "0" }, alignItems: "center" }}>
            ...
            <Box sx={{ width: { xs: "100%", md: "50%" }, padding: { xs: "1em 2em", md: "3em 5em" }, color: "#fff", textAlign: "left", display: "flex", gap: "2em", flexDirection: "column", order: { xs: 2, md: 1 } }}>
                ...
                <Box sx={{ display: "flex", gap: "2em" }}>
                    ...
                    <Box sx={{ display: "flex", alignItems: "center", gap: ".5em" }}>
                        <Check sx={{ color: "#03A9F4" }}/>
                        <Typography sx={{ fontFamily: "Poppins, sans-serif",  }}>Gravações</Typography>
                    </Box>
                </Box>
                <Typography sx={{ fontFamily: "Poppins, sans-serif",  }}>Utilizada para ensaios e gravações, a sala técnica foi construída em um grande espaço de Xm2, possibilitando o uso para artistas ou bandas de pequeno a grande porte.</Typography>
                <Typography sx={{ fontFamily: "Poppins, sans-serif",  }}>Possui acústica profissionalmente planejada, pensando em extrair o melhor de todos os instrumentos e vozes.</Typography>
